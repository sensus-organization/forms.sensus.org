              ...
              <DropdownMenuContent align="start">
                <DropdownMenuItem
                  ...
                  <p className="text-slate-700">
                    {t(
                      selectedFilter.onlyComplete
                        ? "environments.surveys.summary.filtered_responses_csv"
                        : "environments.surveys.summary.current_view_csv"
                    )}
                  </p>
                </DropdownMenuItem>
                <DropdownMenuItem
                  ...
                  <p className="text-slate-700">
                    {t(
                      selectedFilter.onlyComplete
                        ? "environments.surveys.summary.filtered_responses_excel"
                        : "environments.surveys.summary.current_view_excel"
                    )}
                  </p>
                </DropdownMenuItem>
                <DropdownMenuItem
